...
type PhotoDetailNavigationProp = StackNavigationProp<PhotoGalleryStackParamList, 'PhotoDetail'>;
type PhotoDetailRouteProp = RouteProp<PhotoGalleryStackParamList, 'PhotoDetail'>;
...
const PhotoDetailScreen = () => {
  ...
  // Set the URL in the header using navigation.setOptions
  useEffect(() => {
